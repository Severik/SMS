 ...
 */
@WebServiceClient(name = "Service", targetNamespace = "http://smsc.ua/sys/soap.php", wsdlLocation = "http://smsc.ua/sys/soap.php?wsdl")
public class Service
        extends javax.xml.ws.Service {

    private final static URL SERVICE_WSDL_LOCATION;
    private final static WebServiceException SERVICE_EXCEPTION;
    private final static QName SERVICE_QNAME = new QName("http://smsc.ua/sys/soap.php", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://smsc.ua/sys/soap.php?wsdl");
    ...
    public ServiceSoap getServiceSoap() {
        return super.getPort(new QName("http://smsc.ua/sys/soap.php", "ServiceSoap"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://smsc.ua/sys/soap.php", "ServiceSoap"), ServiceSoap.class, features);
    }
